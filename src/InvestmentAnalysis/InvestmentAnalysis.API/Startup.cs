using InvestmentAnalysis.Application.Handlers.CommandHandlers;
...
using InvestmentAnalysis.Infrastructure.Repositories.Base;
using MediatR;
...
namespace InvestmentAnalysis.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IInvestimentAnalysisRepository), typeof(InvestimentAnalysisRepository));
